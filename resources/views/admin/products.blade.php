...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-3">
            <button type="click" id="button_product_item"class="active btn btn-primary w-100">Mostras Lista de productos</button>
        </div>
        <div class="col-3">
            <a href="/admin/exports/products" class="btn btn-primary w-100">Exportar Lista de productos</a>
        </div>
        <div class="col-3">
            <button type="click" id="button_product_item"class="btn btn-primary w-100">Importar Lista productos</button>
        </div>
    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-3">
                                ...
                                <select name="" class="form-control" id="product_code" required></select>
                            </div>
                            <div class="col-4 mt-auto">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_add_code">Agregar nuevo codigo</button>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control" id="product_name" required placeholder="Filtro para motor">
                            </div>
                            <div class="col-3 mt-auto">
                                <label for="exampleInputEmail1">Es compatible con algun vehiculo</label>
                                <input type="checkbox" id="is_vehicule" name="is_vehicule" class="ml-2">
                            </div>
                            <div class="col-6 mt-auto hidden-content" id="vehicule_input">
                                <label for="exampleInputEmail1">Vehiculo Marca - Modelo</label>
                                <select name="" id="product_compatible_vehicule" class="form-control">
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-3">
                                ...
                                <input type="number" required class="form-control" id="product_quantity" name="product_quantity" placeholder="20">
                            </div>
                        </div>
                    </div>
                    @else
                    <div class="form-group">
                        <div class="row">
                            <div class="col-3">
                                ...
                                <input type="number" class="form-control" step="0.001" id="price_buying" name="price_buying" placeholder="30">
                            </div>
                            <div class="col-3">
                                <label>Precio de Venta</label>
                                <input type="number" class="form-control" step="0.001" id="price_selling" name="price_selling" placeholder="10">
                            </div>
                            <div class="col-3">
                                <label>Cant. Disponible</label>
                                <input type="number" required class="form-control" id="product_quantity" name="product_quantity" placeholder="20">
                            ...
                            <div class="col-3">
                                ...
                                <input type="number" disabled  class="form-control" id="approximate_earnings" placeholder="20">
                            </div>
                        </div>
                    </div>
                    @endif
  ...
  <div class="modal fade" id="modal_add_code" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="col-12">
               <form method="post" id="add_code">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="product_code_add" name="product_code_add" required placeholder="CD584AE2">
                    </div>
   ...
   {{-- MODAL EDIT PRODUCT --}}
   <div class="modal fade" id="modal_edit_product" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
            ...
            <div class="col-12">
               <form method="post" id="edit_product">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="product_edit_name" name="product_edit_name" placeholder="CD584AE2">
                    </div>
                    <div class="form-group">
                        <label>Precio de compra</label>
                        <input type="number" step="0.001" class="form-control" id="product_edit_buying" name="product_edit_buying" placeholder="CD584AE2">
                    </div>
                    <div class="form-group">
                        <label>Precio de venta</label>
                        <input type="number" step="0.001" class="form-control" id="product_edit_selling" name="product_edit_selling" placeholder="CD584AE2">
                    </div>
                    <div class="form-group">
                        <label>Cantidad</label>
                        <input type="number" class="form-control" id="product_edit_quantity" name="product_edit_quantity" placeholder="CD584AE2">
                    </div>
                    <div class="form-group">
                        <label>Ganancias aproximadas</label>
                        <input type="number" disabled class="form-control" id="product_edit_earnings" name="product_edit_earnings" placeholder="CD584AE2">
                    </div>
                    <input type="hidden" id="product_edit_id" value="">
                    <button type="submit" class="btn btn-primary"  id="btn_edit_product_edit">Editar Producto</button>
               </form>
            </div>
          </div>
        </div>
  ...
  <script>
   ...
   if(getUserRol != 'GERENCIA') {
    ...
    getInputPriceSelling.addEventListener('input',()=>{
        calculateApproximateEarnings(getInputPriceSelling, getInputPriceQuantity, getInputPriceBuying, false)
    })
    ...
    async function enableListVehicules() {
        ...
        assignStatus.innerHTML = `<div class="alert alert-success" >Cargando Modulos...</div>`
        let response = await fetch('/admin/get-vehicules')
        let data = await response.json()
        if(data.success == true){
            assignStatus.innerHTML = ''
            assignStatus.innerHTML = `<span class="p-2 bg-success"">Carga Finalizada </span>`
            timeHoverStatus()
            getInputVehicule.innerHTML = ''
            data.vehicules.forEach(vehicule => {
                getInputVehicule.innerHTML += `<option value="${vehicule.id}">${vehicule.vehicule_brand_model} - ${vehicule.vehicule_date} - ${vehicule.vehicule_motor_lits} - ${vehicule.vehicule_motor_system} </option>`
            });
        }
    }
    ...
    async function assignListCategoryChecbox(){
        ...
        if(data.success == true){
            ...
            data.categories.forEach((category, index) => {
                categoryCheckboxContent.innerHTML += `<div class="col-2"><span>${category.name}</span><input type="checkbox" value="${category.id}" id="product_relation_check"></div>`
            })
        }
    }
    ...
    getFormNewProduct.addEventListener('submit', async (e)=>{
        ...
        if(getUserRol != 'GERENCIA'){
            ...
            if(getProductPriceBuy.value == 0 || getProductPriceSell.value == 0){
                assignStatus.innerHTML = ''
                assignStatus.innerHTML = `<span class="p-2 bg-danger">El producto debe tener un precio mayor a 0</span>`
                timeHoverStatus()
                return
            }
        }
        ...
        let getCategoriesProduct = document.querySelectorAll('#category_checbox input[type="checkbox"]:checked')
        categoryByProductSelected = Array.from(getCategoriesProduct).map(category => category.value)

        if(categoryByProductSelected == ''){
            assignStatus.innerHTML = ''
            assignStatus.innerHTML = `<span class="p-2 bg-danger">El producto debe pertenecer a alguna categoria</span>`
            timeHoverStatus()
            return
        }
        ...
        if(getUserRol != 'GERENCIA') {
            productObj = {
                ...
                product_image: getFormNewProduct.product_image.files[0],
    ...
    async function showTableContentList(){
       ...
       let response = await fetch('/admin/get-products').catch((error)=>{console.log(error)})
       let data = await response.json()
       if(data.success == true){
    ...
    function searchAllBtnDeleteProduct(){
       ...
       getButtonsDelete.forEach(buttonDelete => {
            buttonDelete.addEventListener('click', async ()=>{
                ...
                let response = await fetch(`/admin/delete-product/${buttonDelete.value}`, options).catch((error)=>{console.log(error)})
                let data = await response.json()
                if(data.success == true){
                    await showTableContentList()
    ...
    function searchAllBtnEditProduct(){
        ...
        getButtons.forEach(buttonEdit => {
            ...
            await editProductTemplate(getProductID,setEditName, setEditProductBuy, setEditProductSell, setEditProductQuantity, setEditProductEarning, setEditProductID).then(()=>{

                setEditProductSell.addEventListener('input',()=>{
                    calculateApproximateEarnings(setEditProductSell, setEditProductQuantity, setEditProductBuy, true)
                })
    ...
    async function editProductTemplate(productID, editName, editProductBuy, editProductSell, editProductQuantity, editProductEarning, editProductID) {
    ...
    getBtnProductEdit.addEventListener('click', async (e)=>{
        ...
        productObj = {
            ...
            product_edit_price_sell: getFormProductEdit.elements.namedItem('product_edit_selling').value,
        ...
        await editProductSubmit(productObj).then( async (data)=>{
            if(data.success == true){
                ...
                setTimeout(() => {
                    ...
                    const getModalEditProduct = document.querySelector('#modal_edit_product')
                    const modalEditProduct = bootstrap.Modal.getInstance(getModalEditProduct);
            ...
            await editProductSubmit(productObj).then( async (data)=>{
                ...
                if(data.success == true){
                    ...
                    getFormProductEdit.elements.namedItem('product_edit_id').value = ''
                    getFormProductEdit.elements.namedItem('product_edit_name').value = ''
                    getFormProductEdit.elements.namedItem('product_edit_buying').value = ''
                    getFormProductEdit.elements.namedItem('product_edit_selling').value = ''
                    getFormProductEdit.elements.namedItem('product_edit_quantity').value = ''
                    getFormProductEdit.elements.namedItem('product_edit_earnings').value = ''
    ...
    async function editProductSubmit(obj) {
        ...
        let response = await fetch(`/admin/edit-product/`, options).catch((error)=>{console.log(error)})
        let data = await response.json()
        return data
    }
